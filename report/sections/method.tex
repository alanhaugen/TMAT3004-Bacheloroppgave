...
OpenCV-prosjektet bruker også cmake. OpenCV 3.4 ble anvendt til å lage OBJECT\_DETECTOR. Det er mulig å installere OpenCV fra kildekode, og kompilere prosjektet med hjelp av QtCreator.
