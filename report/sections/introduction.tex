...
\begin{figure} 
\begin{center} 
\includegraphics[scale=0.1]{figures/retinanet_cod}
\includegraphics[scale=0.1]{figures/retinanet_cod_2}
\includegraphics[scale=0.1]{figures/retinanet_cod_3}
\caption{\small \sl Eskempelbilder av datasettet med inference. \label{fig:data}} 
\end{center} 
\end{figure} 

Her presenteres automatisk fiskedeteksjon av torsk og sei fra bilder tatt med undervannskameraer. Fiskene er i og under merder brukt til fiskeoppdrett. Se figur \ref{fig:data}.

Dette arbeidet er viktig for å forstå omfanget av torsk og sei som trekker til oppdrettsanlegg og spiser oppdrettsfôr fra under merdene. Forskere, samt fiskere og oppdrettsnæringen ønsker å samle informasjon om villfisk spiser fôr som gis til oppdrettsfisk, fôret kan til forskjellige tider inneholde medisinrester. Manuell analyse av data fra undervannskameraer er tidskrevende, dessuten kan det kreve ekspertkunnskap om forskjellige fiskearter. Dette gjør det veldig vanskelig å gjennomføre et større datainnsamlingsprosjekt. Men å gjøre analysen er viktig, kunnskap om økosystemene, og effekten av oppdrettsnæringen, er viktig for fiskere og den norske befolkningen som spiser norsk fisk. Derfor er verktøy som gjør automatisk videoanalyse nødvendig, og bør bli utviklet for å støtte forskere i arbeidet deres.

Dette prosjektet er gjort i samarbeid med Nofima som del av Sameksistens prosjektet \cite{Robertsen 2020}. Dataprogrammet som har blitt utviklet for denne oppgaven kan ta imot undervannsfilm med en høy oppløsning og telle antall norsk torsk og sei.
