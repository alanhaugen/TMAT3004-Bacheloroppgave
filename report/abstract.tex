...
YOLOv4 og RetinaNet anvendes for fiskedeteksjon. Begge modellene bruker CNN konsepter hentet fra forhåndstrente nettverk. Det ble utviklet et datasett basert på video fra og ved lagringsmerder av fisk. En objektdeteksjonspresisjon på (--)mAP har blitt oppnådd, med en normalisert tellingsverdi på  (--) \% på datasettet.
