...
%hva du har undersøkt
Her beskrives resultatene av bruk av maskinsyn for deteksjon av ulike fiskearter. Prosjektet var en del av Sameksistens prosjektet til Nofima. Objektdetekeringen baserer seg på dype nevrale nettverk og er i stand til å skille mellom forskjellige fiskearter.

%hvordan du gjorde det
YOLOv3 og RetinaNet anvendes for fiskedeteksjon. Begge modellene bruker CNN konsepter hentet fra forhåndstrente nettverk, de er basert på konsepter fra COCO datasettet. Det ble utviklet et datasett basert på data fra og ved lagringsmerder av fisk. En objektdeteksjonspresisjon på 66 \% har blitt oppnådd, med en normalisert tellingsverdi på  58 \% på datasettet.
